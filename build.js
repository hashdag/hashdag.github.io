...
.sig { font-size: 12px; color: #1a1a1a; margin-bottom: 1.5rem; display: block; }
.entry { margin-bottom: 1.2rem; padding-bottom: 1.2rem; border-bottom: 0.5px solid #e8e8e8; }
.entry:last-of-type { border-bottom: none; }
.meta { font-size: 11px; color: #888; margin-bottom: 0.3rem; }
.tag { margin-left: 0.5em; }
.body { font-size: 12px; color: #1a1a1a; line-height: 1.7; }
